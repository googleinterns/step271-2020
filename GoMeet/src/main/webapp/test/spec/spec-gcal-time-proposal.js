...
describe('displayAutoGeneratedTimes', function() {
  ...
  it('displays all the times retrieved from the server in individual <p> \
    ...
    for (let i = 0; i < TIME_DATA_DISPLAYED.length; i++) {
      expect(generateTimesDiv.children.item(i).innerText)
          .toEqual(new Date(TIME_DATA_DISPLAYED[i]).toLocaleString('en-AU'));
      console.log(generateTimesDiv.children.item(i).innerText);
    }
  });
